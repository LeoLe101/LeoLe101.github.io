 ...
 * @memberOf Rectangle
 * @param {Rectangle} otherRect  another Obstacle that being tested
...
Rectangle.prototype.collidedRectRect = function (r1, r2, collisionInfo) {
    ...
    //find Axis of Separation for both Obstacle
    status1 = r1.findAxisLeastPenetration(r2, collisionInfoR1);

    if (status1) {
        status2 = r2.findAxisLeastPenetration(r1, collisionInfoR2);
        if (status2) {
            //if both of Obstacles are overlapping, choose the shorter normal as the normal       
...
Rectangle.prototype.collidedRectCirc = function (otherCir, collisionInfo) {
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (projection > 0) {
            //if the center of circle is outside of Obstacle
    ...
    if (!inside) {
        //the center of circle is outside of Obstacle
        ...
        //the center of circle is inside of Obstacle
        radiusVec = this.mFaceNormal[nearestEdge].scale(otherCir.mRadius);
        collisionInfo.setInfo(otherCir.mRadius - bestDistance, this.mFaceNormal[nearestEdge], circ2Pos.subtract(radiusVec));
    }
    return true;
