...
var Obstacle = function (center, width, height, mass, friction, restitution) {
    ...
    //mFaceNormal is normal of face toward outside of Obstacle
...
prototype.constructor = Obstacle;
Obstacle.prototype = prototype;

Obstacle.prototype.rotate = function (angle) {
    this.mAngle += angle;
    var i;
...
Obstacle.prototype.move = function (v) {
    var i;
    for (i = 0; i < this.mVertex.length; i++) {
...
Obstacle.prototype.updateInertia = function () {
